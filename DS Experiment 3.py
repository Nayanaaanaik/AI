...
salary_mean = clean["Salary_INR"].fillna(clean["Salary_INR"].mean())
salary_median = clean["Salary_INR"].fillna(clean["Salary_INR"].median())
gender_mode = clean["Gender"].fillna(clean["Gender"].mode()[0])
...
city_encoded = pd.get_dummies(clean["City"], prefix="City")

clean = pd.concat([clean, city_encoded], axis=1)
# ------------------------------------------------------------
# Feature Engineering
# ------------------------------------------------------------
...
clean["Customer_Value_Index"] = (
    clean["Annual_Income"] / clean["Monthly_Spending"]
)
# ------------------------------------------------------------
